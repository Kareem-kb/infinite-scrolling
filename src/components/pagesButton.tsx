...
<button className={`${styles.button} ${currentPage === 1 ? styles.active : ''}`}         onClick={() => onPageChange(1)}
>
...
/>
      ...
      {/* skipcq: JS-0417 */}
      <button className={`${styles.button} ${currentPage === 2 ? styles.active : ''}`}         onClick={() => onPageChange(2)}
      >
      <div className={styles.buttonContent}>
          <svg
          fill='none'
